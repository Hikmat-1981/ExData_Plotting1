...
with(hpc_subset,plot(Time,Global_active_power,type="l",ylab="Global active power(kilowats)"))
with(hpc_subset,plot(Time,Voltage,type="l",ylab="Global active power(kilowats)"))
...
with(hpc_subset,plot(Time,Global_reactive_power ,type="l",ylab="Global active power(kilowats)"))
